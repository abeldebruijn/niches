...
export default function CreatePage() {
  ...
  const handleStartGame = async () => {
    ...
    try {
      ...
      const message =
        startError instanceof Error ? startError.message : "Could not start game.";
      setError(message);
    } finally {
      setIsStarting(false);
    }
  ...
  return (
    <AppShell
      title="Host Setup"
      subtitle="Share your 6-digit code, tune timer settings, and make sure everyone submits all 3 questions."
