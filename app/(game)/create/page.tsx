...
export default function CreatePage() {
	...
	return (
		<div className="container mx-auto px-4 py-6 space-y-4">
			<Card className="border-2 border-foreground/10 bg-white/85 sticky top-6 backdrop-blur z-10 ">
				<CardContent className="flex justify-between items-start gap-4 flex-col sm:flex-row">
					<div className="flex flex-wrap items-center gap-3">
						<CardTitle className="text-xl">Lobby code:</CardTitle>
						<div className="rounded-2xl border-2 border-foreground/20 bg-white px-4 py-2 font-mono text-3xl font-black tracking-[0.2em] text-foreground">
							{lobby.code}
						</div>
					...
					<div className="flex flex-wrap items-center gap-3">
						...
						{!lobby.canStart ? (
							<p className="text-sm text-foreground/70">
								Start unlocks when there are at least 2 players and everyone has
								easy, medium and hard questions saved.
							</p>
						) : null}
					</div>
				</CardContent>
